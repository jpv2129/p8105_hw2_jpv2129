...
weight of trash collected by Professor Trash Wheel? 282 tons. What was
the total number of cigarette butts collected by Gwynnda in June of
2022? 18,120 cigarette butts.
...
zipcodes_df = read_csv("data/zillowdata/zipcodes.csv", na = c("NA", ".", "")) |>  
  ...
  select(
    -file_date,
    -county  # Remove county from zipcodes_df to avoid duplication
  )
```
...
# First, create the borough column from county
tidy_df <- tidy_df %>%
  mutate(
    borough = case_when(
...
``` r
# Clean analysis with beautiful table
top_drops <- tidy_df %>%
  ...
  select(zip_code, borough, county, jan_2020 = `01/31/20`, jan_2021 = `01/31/21`, price_drop, percent_drop) %>%
...
| zip_code | borough   | county          | jan_2020 | jan_2021 | price_drop | percent_drop |
|---------:|:----------|:----------------|---------:|---------:|-----------:|-------------:|
|    10007 | Manhattan | New York County |  6334.21 |  5421.61 |    -912.60 |       -14.41 |
|    10009 | Manhattan | New York County |  3406.44 |  2692.19 |    -714.25 |       -20.97 |
|    10016 | Manhattan | New York County |  3731.14 |  3019.43 |    -711.70 |       -19.07 |
|    10001 | Manhattan | New York County |  4108.10 |  3397.65 |    -710.45 |       -17.29 |
|    10002 | Manhattan | New York County |  3645.42 |  2935.11 |    -710.30 |       -19.48 |
|    10004 | Manhattan | New York County |  3149.66 |  2443.70 |    -705.96 |       -22.41 |
|    10038 | Manhattan | New York County |  3573.20 |  2875.62 |    -697.59 |       -19.52 |
|    10012 | Manhattan | New York County |  3628.57 |  2942.34 |    -686.22 |       -18.91 |
|    10010 | Manhattan | New York County |  3697.28 |  3012.35 |    -684.93 |       -18.53 |
|    10003 | Manhattan | New York County |  3569.78 |  2897.24 |    -672.54 |       -18.84 |
