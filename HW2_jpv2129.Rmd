...
dim(tidy_df)
```
Description of tidy_df: There are a total of 17, 516 observations and 9 variables. There are 43 unique neighborhoods. There are 149 unique zip codes. Tidy_df is a combination of the zip codes dataset and the ZORI dataset, which includes data for the Zillow Observed Rent Index
